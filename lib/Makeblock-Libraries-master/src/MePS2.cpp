...
void MePS2::loop(void)
{
 if(readjoystick())
 {
   ...
   ps2_data_list[MeJOYSTICK_SQUARE] = (buffer[5] & 0x01) == 0x01 ? true : false;
   ps2_data_list[MeJOYSTICK_XSHAPED] = (buffer[5] & 0x02) == 0x02 ? true : false;
   ps2_data_list[MeJOYSTICK_ROUND] = (buffer[5] & 0x04) == 0x04 ? true : false;
   ps2_data_list[MeJOYSTICK_TRIANGLE] = (buffer[5] & 0x08) == 0x08 ? true : false;
